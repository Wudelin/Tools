...
public final class WResUtil {
    ...
    public static DisplayMetrics getDisplayMetrics(Context context) {
        return getResource(context).getDisplayMetrics();
    }
    ...
    public static int dp2px(Context context, float dpValue) {
        return (int) (TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dpValue, getDisplayMetrics(context)) + 0.5f);
    }
     ...
     * @return 资源ID
     */
    public static int getIdentifierForDrawable(Context context, String drawableName) {
        try {
    ...
    public static int getNavBarHeight(Context context) {
        Resources res = getResource(context);
